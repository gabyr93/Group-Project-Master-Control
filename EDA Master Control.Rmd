...
### Export Cluster Labels for Modeling

```{r save-cluster-labels}
saveRDS(
  leads_clustered %>% select(qal_id, account_cluster, title_cluster),
  "data/cluster_labels.rds"
)
saveRDS(
  mx_leads %>% select(qal_id, mx_cluster),
  "data/mx_cluster_labels.rds"
)
```
