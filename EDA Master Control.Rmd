...
Each cluster represents a distinct account archetype. Compare the conversion rates above to the Mx baseline of 12.7%. Clusters with above-average conversion contain the account profiles MasterControl should prioritize for Mx targeting. Clusters with very low conversion (especially those dominated by "Low Info" or "Non-Mfg") represent targeting waste.
